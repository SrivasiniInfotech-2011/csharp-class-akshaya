...
namespace chap13
{
    ...
    */
    ...
    //            try
    //            {
    //                //FileStream fs = new FileStream(@"D:\test1.txt", FileMode.Create, FileAccess.Write);
    //                //FileStream fs = new FileStream(@"D:\test1.txt", FileMode.OpenOrCreate, FileAccess.Write);
    //                //FileStream fs = new FileStream(@"D:\test1.txt", FileMode.Append, FileAccess.Write);
    //                FileStream fs = new FileStream(@"D:\test1.txt", FileMode.CreateNew, FileAccess.Write);
    ...
    //        {
    //            FileStream fs1 = new FileStream(@"D:\test1.txt", FileMode.Open, FileAccess.Read);
